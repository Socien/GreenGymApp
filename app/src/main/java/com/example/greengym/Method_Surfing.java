...
public class Method_Surfing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_method__surfing);

        //액션바 제목
        ActionBar actionbar = getSupportActionBar();
        actionbar.setTitle("파도타기");
        ...
        youtube.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                String url = "https://www.youtube.com/watch?v=bLLZhW26i-U";
